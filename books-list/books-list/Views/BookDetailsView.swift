...
class BookDetailsView: UIView {
    ...
    lazy var bookDescription: UILabel = {
        ...
        bookDescription.text = "The content elements of your scroll view must have left / top / width / height values. In the case of objects such as labels, they have intrinsic sizes, so you only have to define the left & to"
